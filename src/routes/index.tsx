...
function Index() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      {/* HERO */}
      <section id="inicio" className="relative min-h-screen flex items-center overflow-hidden max-md:min-h-[calc(100svh-5rem)] max-md:items-start">
        <div className="absolute inset-0">
          <img
            src={heroCar}
            alt="Veículo premium GETCARS"
            className="h-full w-full object-cover object-[55%_center] lg:object-[75%_center] max-md:object-[90%_80%]"
            width={1920}
            height={1080}
          />
          <div className="absolute inset-0 bg-gradient-to-r from-background via-background/60 md:via-background/70 lg:via-background/85 to-transparent max-md:via-background/60" />
          <div className="absolute inset-0 bg-gradient-to-t from-background via-background/20 to-background/45 lg:via-background/30 lg:to-background/60 max-md:from-background/65 max-md:via-background/20 max-md:to-background/80" />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_left,oklch(0.08_0.005_60/0.35),transparent_60%)] lg:bg-[radial-gradient(ellipse_at_left,oklch(0.08_0.005_60/0.6),transparent_60%)] max-md:bg-[radial-gradient(ellipse_at_left,oklch(0.08_0.005_60/0.75),transparent_85%)]" />
          <div className="absolute inset-0 bg-gradient-to-b from-background/35 via-transparent to-background/55 lg:from-background/60 lg:to-background/80 max-md:from-background/80 max-md:via-transparent max-md:to-background/30" />
        </div>
